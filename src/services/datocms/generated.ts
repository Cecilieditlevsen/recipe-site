...
/** Block of type Ingredient Block (ingredient_block) */
export type IngredientBlockRecord = RecordInterface & {
...
/** Block of type Ingredient Block (ingredient_block) */
export type IngredientBlockRecord_seoMetaTagsArgs = {
  locale: InputMaybe<SiteLocale>
}
...
/** The query root for this schema */
export type Query_allRecipesMetaArgs = {
  fallbackLocales: InputMaybe<Array<SiteLocale>>
...
export type RecipeRecord = RecordInterface & {
  ...
  id: Scalars['ItemId']
  ingredients: Array<IngredientBlockRecord>
...
/** Record of type Recipe (recipe) */
export type RecipeRecord_seoMetaTagsArgs = {
  locale: InputMaybe<SiteLocale>
}
...
export type GetSingleRecipeQuery = {
  __typename?: 'Query'
  recipe: {
    __typename?: 'RecipeRecord'
    title: string | null
...
`
export const GetSingleRecipeDocument = gql`
...
export function getSdk(
  ...
  return {
    ...
    ): Promise<GetAllRecipesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAllRecipesQuery>(GetAllRecipesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetAllRecipes',
    ...
    GetSingleRecipe(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetSingleRecipeQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSingleRecipeQuery>(
            GetSingleRecipeDocument,
            variables,
